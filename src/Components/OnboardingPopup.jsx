            ...
            messages: [
              {
                role: "user",
                content:
                  "Give me 4 popular male actors and 4 popular female actors right now. Return only JSON: {male: [names], female: [names]}",
              },
            ],
            max_tokens: 200,
            temperature: 0.8,
            ...
            messages: [
              {
                role: "system",
                content:
                  "Give one short interesting fun fact about this actor.",
              },
    ...
    <div className="onboarding-overlay">
      <div className="onboarding-modal">
        <div className="modal-header">
          ...
          <button className="pop-close-btn" onClick={handleComplete}>
            ×
          </button>
        </div>
        ...
        {step === 1 && (
          <div className="step">
            ...
            {loadingActors && (
              <p className="loading">
                AI is finding fresh actors with real photos...
              </p>
            )}
          </div>
        )}
        ...
        {step === 3 && selectedActor && (
          <div className="step">
            ...
            <div className="feedback-buttons">
              ...
              <button
                className={`dislike-btn ${feedback === "dislike" ? "active" : ""}`}
